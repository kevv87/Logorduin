...
class Parser implements ParserTokens {
    ...
    private int yyr34() { // float_number : IDENTIFIER
        { yyrv=(double)variables.get(((String)yysv[yysp-1])); }
        yysv[yysp-=1] = yyrv;
        return yypfloat_number();
    }
    ...
    private int yyr26() { // int_number : IDENTIFIER
        {yyrv=(int)variables.get(((String)yysv[yysp-1]));}
        yysv[yysp-=1] = yyrv;
        return yypint_number();
    }
