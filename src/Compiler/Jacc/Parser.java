// Output created by jacc on Tue Jul 21 04:21:34 CST 2020
...
class Parser implements ParserTokens {
    ...
    private int yyr2() { // prog : expression
        {/*if(yysv[yysp-1] instanceof ArrayList){
                       acciones.addAll((ArrayList<jsonAction>)yysv[yysp-1]);
                   }else if(yysv[yysp-1] instanceof jsonAction){
                       acciones.add((jsonAction)yysv[yysp-1]);
    ...
    private int yyr181() { // void_proc_1p : REPITE int_number '[' expr_procs_n ']'
        {jsonAction result = new jsonAction();result.setComplejo((ArrayList<jsonAction>)yysv[yysp-2]);result.setRepeticiones((Integer)((Integer)yysv[yysp-4]));yyrv=result;}
        yysv[yysp-=5] = yyrv;
        return 25;
    }
